...
export const presentationCopy = {
  de: {
    ...
    presentationAria: "Oki und das Geheimnis der Inseln – HTML-Präsentation",
  ...
  en: {
    ...
    presentationAria: "Oki and the Secret of the Islands – HTML presentation",
  ...
  es: {
    ...
    presentationAria: "Oki y el secreto de las islas – presentación HTML",
  ...
  fa: {
    ...
    presentationAria: "اوکی و راز جزیره‌ها – ارائهٔ HTML",
  ...
  zh: {
    ...
    finaleLabel: "OpenKubes",
    aboutLabel: "继续探索",
    presentationAria: "奥奇与群岛的秘密 – HTML 演示",
  ...
  ja: {
    ...
    finaleLabel: "OpenKubes",
    aboutLabel: "もっと知ろう",
    presentationAria: "オキと島々の秘密 – HTML プレゼンテーション",
  ...
  ar: {
    ...
    presentationAria: "أوكي وسرّ الجزر – عرض HTML",
  ...
  fr: {
    ...
    presentationAria: "Oki et le secret des îles – présentation HTML",
  ...
  hi: {
    ...
    presentationAria: "ओकी और द्वीपों का रहस्य – HTML प्रस्तुति",
  ...
  pt: {
    ...
    presentationAria: "Oki e o segredo das ilhas – apresentação HTML",
    slideAnnouncement: "Slide",
    of: "de",
    menu: "Visão geral",
